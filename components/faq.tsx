...
export default function FAQ() {
  ...
  // Fetch translated FAQ items
  const translatedFAQs = t.raw('items') as Array<{ question: string; answer: string }>;

  // Combine mockFAQs IDs with translated questions and answers
  const faqs = mockFAQs.map((faq, index) => ({
    id: faq.id,
    question: translatedFAQs[index]?.question || faq.question,
    answer: translatedFAQs[index]?.answer || faq.answer,
  }));
